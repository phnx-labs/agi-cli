...
- [x] Reproduce selected-slot versus spawned-home mismatch; verify token presence without exposing credentials.
- [x] Fetch current CLI source and discover overlapping PHNX-3940 work / PR3512.
- [x] Audit local selection, fallback, readiness, and execution.
- [x] Audit account migration, update, sync, and credential lifecycle.
