...
fail=0
for mode in MENUBAR_GUARD_TEST MENUBAR_ISSUE_TEST MENUBAR_PROJECTS_TEST MENUBAR_SINGLE_TEST MENUBAR_CHILD_TEST MENUBAR_ACTIVE_TEST MENUBAR_ROUTINE_TEST MENUBAR_DOCTOR_TEST MENUBAR_DEVICE_TEST MENUBAR_FEED_TEST MENUBAR_ARTIFACT_TEST MENUBAR_OCR_TEST; do
  echo "=== $mode ==="
