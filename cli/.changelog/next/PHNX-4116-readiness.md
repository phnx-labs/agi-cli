- **One run-readiness gate, computed on the box that runs (PHNX-4116).** `agents view --json`
  ...
  `no ready harness account`. Source: `cli/src/commands/view.ts`, `cli/src/lib/hosts/ready.ts`,
  `cli/src/lib/accounting/rotate.ts`, `cli/src/lib/accounting/usage.ts`, `cli/src/lib/smart-launch.ts`.
