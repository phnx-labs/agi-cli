- **Replacing the browser daemon no longer kills a live browser (PHNX-3999).** The
  ...
  preserved browser transfers only after an identity-checked attach succeeds, and that
  rewrites the owning-daemon pid alone, keeping the original launch's metadata. Source:
