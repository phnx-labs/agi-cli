 ...
 * (the tsconfig exclude entry for `__tests__` dirs — written in prose because a
 * literal glob would close this block comment early). `title.ladder-completeness.test.ts` runs
